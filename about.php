    ...
    <div class="containers">
        <nav>
            ...
            <ul>
                ...
                <li><a href="about.php" class="font-weight-bold">About</a></li>
        ...
        <p class="ml-5 h1 font-italic">Information about system</p>
        <div class="w-50 p-3">
        <p class="h3 font-light">The COPOS Mapping System is build to manage and add Course, Course OutComes, Program OutComes of the student Semester Wise.</p>
        <p>Teacher Can ADD CO</p>
        <p>Mapp CO With PO's</p>
        <p>Admin Manage all Faculty data</p>
        </div>
        </div>
        </div>
        </div>
