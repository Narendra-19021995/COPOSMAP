          ...
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td><a href="mapping.php?delete=1&id='.$row["Coid"].'" class="delete"><span class="glyphicon glyphicon-remove"></span></a></td>
              </tr>
            ';
          }
        }
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(document).on('click', '.delete', function(){
      ...
      {
        window.location.href="mapping.php?delete=1&id="+id;
      }
      else
      {
        return false;
